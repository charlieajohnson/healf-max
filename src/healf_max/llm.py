...
def offline_turn(
    ...
    *,
    ...
    if safety.category == "urgent_symptoms":
        ...
        answer = (
            "First read: this is probably not a bigger-stack moment. Start with the bottleneck: training load, sleep pressure, enough protein, hydration, and any flagged blood markers. "
